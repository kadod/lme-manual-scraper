...
import { FormStats } from '@/app/actions/forms'
    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">受信した回答の合計</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">フォーム送信率</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {stats.averageCompletionTime ? `${stats.averageCompletionTime}分` : 'N/A'}
          </div>
          <p className="text-xs text-muted-foreground">回答完了までの時間</p>
        </CardContent>
      </Card>
    </div>
  )
