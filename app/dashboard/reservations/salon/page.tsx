...
export default function SalonReservationsPage() {
  const [reservations, setReservations] = useState<SalonReservation[]>([
    {
      id: '1',
      name: '無料相談受付フォーム',
      enabled: true,
    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold">サロン・面談予約</h1>
        ...
        <div className="bg-green-50 border border-green-200 rounded p-4 flex items-center justify-between">
          <p className="text-sm">
            新規作成をクリックして、はじめてのサロン・面談予約を作成しましょう。
          </p>
      ...
      <div className="mb-4">
        ...
        <span className="ml-4 text-sm text-gray-600">
          登録カレンダー数：{reservations.length} / 6
        </span>
      </div>
        ...
        {reservations.map((reservation) => (
          <div key={reservation.id} className="bg-white border rounded-lg overflow-hidden">
            ...
            <div className="px-4 pb-4">
              <Link href={`/dashboard/reservations/salon/${reservation.id}`}>
